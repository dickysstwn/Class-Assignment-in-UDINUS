<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="home.php">
            <img src="assets/img/logo_ootd.jpg" alt="" width="30" class="d-inline-block align-text-top">
            OOTD - Outfit Of The Day Store
        </a>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page"
                        href="<?php echo $level==1 ? 'home.php' : 'product.php' ?>">Product</a>
                </li>
                <li class="nav-item">
