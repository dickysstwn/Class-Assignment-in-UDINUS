...
//Mendefinisikan prosedur push untuk menambah data
void push()
{
	char a[30];
	int b;
	...
	if(hitung(head)<maks){
		...
		if(head==NULL) //kondisi stack masih kosong
		{
			head=baru;	
			head->next=NULL;
			tail=head;
		...
		cout << "FULL... \n Maaf, stack penuh" << endl;
	}
}


//Mendefinisikan prosedur pop untuk menghapus data
void pop()
{
	if(head==NULL)
...
int main(){
	...
	do{
		cout << "=================================================" << endl;
		cout << "------------STACK LINKED LIST PROGRAM------------" << endl;
		cout << "=================================================" << endl;
		cout << "Menu : \n";
		cout << " 1. PUSH (Tambahkan Data) \n 2. POP (Hapus Data) \n 3. Tampilkan Data \n 4. Keluar" << endl;
		cout << "-------------------------------------------" << endl;	
